...
<WebServiceRequestEntity>
   ...
   <name>OBJ.004.10 Get List Projects</name>
   <tag></tag>
   <elementGuidId>a537f9f7-e9c7-4147-89be-1f4134ab8c6a</elementGuidId>
   ...
   <restUrl>${list-account-member}${endpoint}?accountType=performance</restUrl>
   ...
   <variables>
      <defaultValue>'/account-testing'</defaultValue>
      <description></description>
