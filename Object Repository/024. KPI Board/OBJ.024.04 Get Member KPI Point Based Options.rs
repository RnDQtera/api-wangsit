...
<WebServiceRequestEntity>
   ...
   <name>OBJ.024.04 Get Member KPI Point Based Options</name>
   <tag></tag>
   <elementGuidId>2c6628bf-72b0-4db4-b1b7-64aba33b5ad8</elementGuidId>
   ...
   <variables>
      <defaultValue>'api/member/point-based/options'</defaultValue>
      <description></description>
