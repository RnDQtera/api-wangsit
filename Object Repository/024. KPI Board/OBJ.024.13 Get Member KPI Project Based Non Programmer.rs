...
<WebServiceRequestEntity>
   ...
   <name>OBJ.024.13 Get Member KPI Project Based Non Programmer</name>
   <tag></tag>
   <elementGuidId>1f5d2175-5b80-4933-975d-9f3b5abcf9db</elementGuidId>
   ...
   <variables>
      <defaultValue>'api/member/project-based/non-programmer'</defaultValue>
      <description></description>
