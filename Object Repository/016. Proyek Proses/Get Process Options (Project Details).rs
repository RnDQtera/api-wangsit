...
<WebServiceRequestEntity>
   ...
   <name>Get Process Options (Project Details)</name>
   <tag></tag>
   <elementGuidId>fde230df-b5ec-4c62-b837-970746cd41c4</elementGuidId>
   ...
   <restUrl>${proyek_proses}${endpoint}?nameOptions=true&amp;dependencyOptions=false&amp;teamOptions=true&amp;isActive=true</restUrl>
   ...
   <variables>
      <defaultValue>'/project-details/options/66fe2ea7d7c316a8f61846bf'</defaultValue>
      <description></description>
